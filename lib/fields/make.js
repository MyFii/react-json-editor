...
module.exports = function(fields, props) {
  ...
  if (inputComponent) {
    ...
    return wrapped.field(props, <fields.UserDefinedField {...props} />);
    ...
    return <fields.FileField {...ou.merge(props, { mode: hints.fileUpload.mode })} />;
  }
    ...
    return wrapped.field(props, <fields.Selection {...props} />);
  }

  switch (schema.type) {
  case "boolean":
    return wrapped.field(props, <fields.CheckBox {...props} />);
  case "object" :
  ...
  case "string" :
  default:
    return wrapped.field(props, <fields.InputField {...props} />);
  }
};
